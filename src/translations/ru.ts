export const translations = {
  ...
  // Testimonials Stats
  'testimonials.stats.users': 'пользователей по всему миру',
  'testimonials.stats.aiTranslation': 'ИИ перевод (G2)', 
  'testimonials.stats.languages': 'поддерживаемых языков',
  ...
  'footer.feature3': 'Перевод фото',
  'footer.feature4': 'Обучение с ИИ',
