export const translations = {
  ...
  'features.aiTranslation.description': 'Avanceret AI forstår kontekst, idiomer og kulturelle nuancer for naturlige oversættelser.',
  ...
  'features.aiImageInteraction.description': 'Upload billeder for at chatte direkte med AI og modtage svar eller oversættelser.',
  'features.aiImageInteraction.tag': 'AI-billedchat',
  
  'features.photoTranslation.title': 'Fotooversættelsesværktøj',
  'features.photoTranslation.description': 'Genkender perfekt billeder, fotos, noter, kontrakter.',
  'features.photoTranslation.tag': 'Fotooversættelse',
  ...
  // Testimonials
  'testimonials.title': 'Hvad vores brugere siger',
  'testimonials.user1.text': 'AnyTranslator har revolutioneret, hvordan jeg kommunikerer med mine internationale kunder. Nøjagtigheden er utrolig!',
  ...
  'download.title.part1': 'Klar til at bryde',
  'download.title.part2': 'sprogbarrierer?',
  'download.description': 'Download nu og nyd fuld adgang gratis.',
  'download.title': 'Download AnyTranslator',
  'download.subtitle': 'Tilgængelig på alle dine enheder',
